# Mission_to_Mars
This simulation was created to help with choice which type of rocket will be better to send to the mars.

I'ts a project from Udacity course which sounds:
